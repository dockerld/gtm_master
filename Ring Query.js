...
internal_orgs AS (SELECT DISTINCT org_id FROM postgres.org_subscriptions WHERE stripe_subscription_id IN (SELECT subscription_id FROM override_googlesheets_manual_stripe_changes WHERE lower(exclude_reason) = 'internal')),
