...
function setup_daily_notion_crm_triggers() {
  ...
  ScriptApp.newTrigger("sync_orgs_to_notion").timeBased().everyDays(1).atHour(7).nearMinute(30).create()
  ScriptApp.newTrigger("sync_users_to_notion").timeBased().everyDays(1).atHour(7).nearMinute(40).create()
